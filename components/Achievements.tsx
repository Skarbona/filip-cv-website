          ...
          <div className="text-center mb-16">
            <div className="flex justify-center mb-4">
              <div className="p-4 bg-yellow-100 dark:bg-yellow-900/30 shadow-[var(--pixel-box-shadow)] box-shadow-margin">
                <PixelIcon name="trophy-solid" folder="solid" size={32} />
              </div>
            </div>
                ...
                >
                  <CardHeader>
                    <div className="flex items-start gap-4">
                      <div className={`flex-shrink-0 w-10 h-10 flex items-center justify-center font-bold shadow-[var(--pixel-box-shadow)] box-shadow-margin ${colors.badge}`}>
                        {index + 1}
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          {achievement.company && (
                            <span className={`text-xs font-bold pixel-font ${colors.badgeText} ml-2`}>
                              {achievement.company}
                            </span>
                          )}
                        </div>
